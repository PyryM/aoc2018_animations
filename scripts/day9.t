...
terra Ring_t:reset(initial_val: int32)
  self.prevs[0] = 0
  self.nexts[0] = 0
...
terra Ring_t:do_turn(marble_id: int32)
...
terra Ring_t:run_everything(max_marble: int32)
  self.cur_player = 0
...
function Ring:init(capacity, initial_val, n_players)
  ...
  self.vals = terralib.new(int32[capacity])
...
function init()
  ...
  print(string.format("Took %0.6fs", truss.toc(t0)))
  --print(ring:dump())
  local maxv = 0
